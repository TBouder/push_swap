...
/*   Updated: 2016/04/14 15:41:48 by tbouder          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_calls_swap(t_swap *a, t_swap *b)
{
	...
	if (ft_z(a) < ft_y(a))
	{
		...
		!r && ft_z(a) > A && ft_z(b) > A && BNULL ? r = PB : 0;
...
int			ft_calls_push(t_swap *a, t_swap *b, t_flag *flg)
{
	...
	else if (ft_z(a) < ft_y(a))
	{
		...
		!r && ft_z(a) > A && !BNULL && ft_z(b) > ft_y(b) && ft_z(b) < B
			? r = RRR : 0;
		!r && flg->prev < 2 && ft_z(a) > A ? r = RRA : 0;
		!r && flg->prev == 2 && ft_z(a) > A ? r = RA : 0;
		!r && ft_z(a) < A ? r = PA : 0;
		!r && ft_z(a) < A && !BNULL && ft_z(b) < ft_y(b) ? r = SB : 0;
	}
	return (r);
...
int			ft_calls_rev_rot(t_swap *a, t_swap *b)
{
	...
	r = 0;
	//ft_z(b) >= ft_y(b) && ft_z(b) < B ? r = RRB : 0;
	!r && ft_z(b) < ft_y(b) && ft_z(b) > B ? r = RB : 0;
	if (ft_z(a) > ft_y(a))
	{
	...
	if (ft_z(a) < ft_y(a))
	{
		...
		!r && ft_z(a) < A ? r = PA : 0;
		!r && ft_z(a) > A && !BNULL && ft_z(b) > A ? r = PB : 0;
		!r && ft_z(a) > A && !BNULL && ft_z(b) > ft_y(b) && ft_z(b) < B
			&& !ft_order(a) ? r = RRR : 0;
		!r && ft_z(a) > A && !BNULL && ft_z(b) > ft_y(b) && ft_z(b) < B
			&& ft_order(a) ? r = RR : 0;
...
int			ft_calls_rot(t_swap *a, t_swap *b)
{
	...
	if (ft_z(a) < ft_y(a))
	{
		!r && ft_z(a) < A && ft_y(a) < A ? r = PA : 0;
		!r && ft_z(a) > A && !BNULL && ft_z(b) > A ? r = PB : 0;
		!r && ft_z(a) > A && ft_z(b) > ft_y(b) && ft_z(b) < B ? r = RR : 0;
		!r && ft_z(a) > A ? r = RA : 0;
		!r && ft_z(a) < A && !BNULL && ft_z(b) < ft_y(b) ? r = SB : 0;
	}
	return (r);
