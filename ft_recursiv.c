...
/*   Updated: 2016/04/12 17:16:51 by tbouder          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_calls_push(t_swap *a, t_swap *b, t_flag *flg)
{
	...
	if (ft_z(a) > ft_y(a))
	{
		...
		ft_z(a) < A && ft_z(b) >= ft_y(b) ? ft_rs_a(a, b, flg) : 0;
	...
	if (ft_z(a) < ft_y(a))
	{
		ft_z(a) > A && ft_z(b) > ft_y(b) && ft_z(b) < B
			? ft_rrr_ab(a, b, flg) : 0;
		ft_z(a) > A ? ft_rrr_a(a, b, flg) : 0;
		ft_z(a) < A ? ft_rpa_b(a, b, flg) : 0;
		ft_z(a) < A && ft_z(b) < ft_y(b) ? ft_rs_b(a, b, flg) : 0;
	}
	ft_z(b) > ft_y(b) && ft_z(b) < B ? ft_rrr_b(a, b, flg) : 0;
...
void		ft_calls_rev_rot(t_swap *a, t_swap *b, t_flag *flg)
{
	if (ft_z(a) > ft_y(a))
	{
		ft_z(b) < ft_y(b) ? ft_rs_ab(a, b, flg) : 0;
		ft_z(b) >= ft_y(b) ? ft_rs_a(a, b, flg) : 0;
		ft_z(b) < ft_y(b) && ft_z(b) > B ? ft_rs_b(a, b, flg) : 0;
	}
	if (ft_z(a) < ft_y(a))
	{
		ft_z(a) < A && ft_y(a) > A && (a->next->stack < ft_z(a)
			|| ft_is_sorted(a->next)) ? ft_rrr_a(a, b, flg) : 0;
		ft_z(a) < A && ft_y(a) > A ? ft_rpa_b(a, b, flg) : 0;
		ft_z(a) < A && ft_y(a) < A ? ft_rpa_b(a, b, flg) : 0;
		ft_z(a) > A && ft_z(b) > A ? ft_rpb_a(a, b, flg) : 0;
		ft_z(a) > A && ft_z(a) > A && ft_z(b) > ft_y(b) && ft_z(b) < B
			&& !ft_order(a) ? ft_rrr_ab(a, b, flg) : 0;
		ft_z(a) > A && ft_z(a) > A && ft_z(b) > ft_y(b) && ft_z(b) < B
			&& ft_order(a) ? ft_rr_ab(a, b, flg) : 0;
		ft_z(a) > A && ft_z(a) > A && !ft_order(a) ? ft_rrr_a(a, b, flg) : 0;
		ft_z(a) > A && ft_z(a) > A && ft_order(a) ? ft_rr_a(a, b, flg) : 0;
		ft_z(a) < A && ft_z(b) < ft_y(b) ? ft_rs_b(a, b, flg) : 0;
	}
...
void		ft_calls_rot(t_swap *a, t_swap *b, t_flag *flg)
{
	...
	if (ft_z(a) < ft_y(a))
	{
		ft_z(a) < A && ft_y(a) < A ? ft_rpa_b(a, b, flg) : 0;
		ft_z(a) > A && ft_z(b) > A ? ft_rpb_a(a, b, flg) : 0;
		ft_z(a) > A && ft_z(a) > A && ft_z(b) > ft_y(b)
			&& ft_z(b) < B ? ft_rr_ab(a, b, flg) : 0;
		ft_z(a) > A && ft_z(a) > A ? ft_rr_a(a, b, flg) : 0;
		ft_z(a) < A && ft_z(b) < ft_y(b) ? ft_rs_b(a, b, flg) : 0;
	}
	ft_z(b) > ft_y(b) && ft_z(b) < B ? ft_rrr_b(a, b, flg) : 0;
}
